...
var cookieValue = docCookies.getItem("username");
window.onload = function show(){
  if(cookieValue==null||cookieValue=="")
  {
    document.getElementById("loggedOrNot").innerHTML = "Login";
    document.getElementById("loggedOrNot").href = 'login.php';
  }
  else {
    document.getElementById("loggedOrNot").innerHTML = "Logout";
    document.getElementById("loggedOrNot").href = 'logout.php';
  }
}
